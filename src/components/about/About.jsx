...
const About = () => {
  return (
    <div className="h-screen">
      <div className="">
        <h1 className="w-14/15 py-8 text-black text-[2.4vw] font-semibold leading-[1.2] px-6">
        ...
        <div className="w-8/12 flex items-center justify-between gap-5 mx-auto my-25 p-5 border border-black/20 rounded-xl">
          <p className="w-5/12 font-medium text-center text-[0.9vw] text-black">Robots should give you back what matters most — time. Watch how our team came together to work on this mission.</p>
          <div className="w-1/2">
